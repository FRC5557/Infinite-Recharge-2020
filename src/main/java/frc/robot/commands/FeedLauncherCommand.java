...
public class FeedLauncherCommand extends CommandBase{
    ...
    */
    ...
    public void execute(){
        ...
        StorageSubsystem.getInstance().feedLauncher(); //this is the method in the StorageSubsystem class that gets the feed motor rotating at a certain speed.
